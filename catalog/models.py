...
class Language(models.Model):
    """Model representing a language (e.g. English, Frech, Japanse, etc.)"""
    name = models.CharField(
        max_length=200,
        help_text="Enter the book's natural language (e.g. English, Frech, Japanse etc."
    )
...
class BookInstance(models.Model):
    """Model representing a specific copy of a book
       (i.e. that can be borrow from the library)."""
