...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_user1 = User.objects.create_user(
            username='testuser1', password='user1password')
        test_user2 = User.objects.create_user(
            username='testuser2', password='user2password')
        ...
        for book_copy in range(number_of_book_copies):
            return_date = timezone.localdate() + datetime.timedelta(days=book_copy % 5)
    ...
    def test_redirect_if_not_loggged_in(self):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        # Check that we got a reponse "success"
        self.assertEqual(response.status_code, 200)
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check taht we got a response "success"
        self.assertEqual(response.status_code, 200)
